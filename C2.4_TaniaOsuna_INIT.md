C2.4_Estilos_patrones_arquitectura_software.md 10/19/
...
## C2.4 Estilos, patrones de arquitectura de software
...
```
De acuerdo con la documentación indicada por el asesor sobre el tema estilos, y patrones de
arquitectura elaborar un mapa mental.
...
```
```
Ir a especificación de requisitos
```
